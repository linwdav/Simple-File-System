...
all: testp6 test_file_operations test_directory_operations
...
test_directory_operations: test_directory_operations.o p6.o block.o file_operations.o directory_operations.o bitmap_operations.o

clean:
	rm -f testp6 test_file_operations test_directory_operations *.o
